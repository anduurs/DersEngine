...
//
//        Debug.log("TOTAL AMOUNT OF VERTICES IN SCENE: " + ModelManager.getInstance().vertexCounter);
//        Debug.log("TOTAL AMOUNT OF POLYGONS IN SCENE: " + ModelManager.getInstance().vertexCounter / 3);
//    }
//
...
//        NormalMap bricksNormal 		 = new NormalMap(TextureManager.getInstance().loadModelTexture("bricksNormal"));
...
//
//        Entity water = new Entity("Water", 200.0f, 1.0f, 200.0f);
...
//
//        Transform crateTransform = new Transform(new Vector3f(160.0f, 40.0f, 200.0f),
